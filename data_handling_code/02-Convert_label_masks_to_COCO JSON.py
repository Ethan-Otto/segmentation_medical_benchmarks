...
def main():
    ...
    # Split data into train and val and test sets
    
    train_img_paths, val_img_paths, train_mask_paths, val_mask_paths = train_test_split(image_paths, mask_paths, test_size=0.3, random_state=42)
    val_img_paths, test_img_paths, val_mask_paths, test_mask_paths = train_test_split(val_img_paths, val_mask_paths, test_size=0.5, random_state=42)
